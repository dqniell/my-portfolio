const experiences = [
  {
    ...
    description: [
      "Engineered a student card-sort analytics dashboard (React, Vite, Tailwind) visualizing interaction patterns across 40+ questions and 6 instructors, surfacing per-question heatmaps, common wrong answers, and high-error \"decoy\" cards to help research mentors pinpoint student struggle points.",
      "Built automated Python/pandas pipelines to ingest, clean, and process raw Runestone Academy interaction logs — pickling parsed results to eliminate redundant reprocessing — and diagnosed a silent truncation bug dropping ~30% of submissions that was skewing a core research metric by over 2x.",
    ],
    tags: ["React", "Vite", "Tailwind", "Python", "pandas", "NSF-Funded"],
    insertions: 241,
    deletions: 0,
    files: 6,
  },
  ...
  },
  {
    ...
    description: [
      "Identified statistically significant racial disparities in the COMPAS recidivism risk algorithm by conducting logistic regression, survival analysis, and contingency table analysis in Python (pandas, scikit-learn, statsmodels) across a dataset of 7,000+ individuals.",
      "Presented a focused analysis on the influence of juvenile misdemeanor history on COMPAS risk score predictions at the Winter 2024 MDST Project Expo to an audience of 100+ students and faculty.",
    ],
    tags: ["Python", "pandas", "scikit-learn", "statsmodels", "Logistic Regression"],
    insertions: 187,
    deletions: 12,
    files: 5,
  },
  {
    ...
    description: [
      "Streamlined client communication operations managing 200+ daily interactions with 100% on-time delivery of invoices, job confirmations, and estimates by coordinating plumbing job scheduling and email workflows.",
      "Reduced invoice creation time by 75% by decreasing generation time from 20 minutes to under 5 minutes through a custom React-based invoice generator using JavaScript, HTML/CSS, and html2pdf.js.",
    ],
